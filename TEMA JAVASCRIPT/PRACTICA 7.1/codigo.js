...
b.addEventListener("click", muestraPersonajes);


async function mostrarPersonaje(){
    const episodio = document.querySelector(".episodio").value;
    const enlace = `https://rickandmortyapi.com/api/episode/${episodio - 1}`;
